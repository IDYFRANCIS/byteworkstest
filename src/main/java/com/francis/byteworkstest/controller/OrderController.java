...
public class OrderController {
	...
	public ResponseEntity<?> createOrder(@RequestHeader("Authorization") String authorization,
			@RequestBody OrderDto request, @PathVariable("paymentType") PaymentType paymentType,
			@PathVariable("foodType") FoodType foodType, @PathVariable("deliveryType") DeliveryMethod deliveryType) {
	...
	@ResponseBody
	public ResponseEntity<?> getOrderByOrderNumber(@RequestHeader("Authorization") String authorization,
	...
	@ResponseBody
	public ResponseEntity<?> getOrderByPaymentType(@RequestHeader("Authorization") String authorization,
	...
	@ResponseBody
	public ResponseEntity<?> getOrderByFoodType(@RequestHeader("Authorization") String authorization,
			@PathVariable("foodType") FoodType foodType) {
	...
	@ResponseBody
	public ResponseEntity<?> getOrderByDeliveryMethod(@RequestHeader("Authorization") String authorization,
			@PathVariable("deliveryType") DeliveryMethod deliveryType) {
