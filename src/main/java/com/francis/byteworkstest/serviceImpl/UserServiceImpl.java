...
public class UserServiceImpl implements UserService {
	...
	public ServerResponse create(SignUpRequest request) {
		...
		try {
			...
			model.put("message",
					"Welcome to ByteWorks Food Vendor Application and thank you for creating an account. Please confirm your registeration by clicking on the link below to complete your registration process on the system.");
	...
	public ServerResponse userActivation(ActivateUserRequest request) {
		...
		try {
			...
			String activationCode = request.getActivationCode() != null ? request.getActivationCode()
	...
	public ServerResponse reSendUserActivation(ResendUserActivationCodeDto email) {
		...
		try {
			// Checking to ensure user email exist on the system before re-sending
			// activation code
			...
			model.put("message",
					"We received a request to re-send your activation code, if this is correct, please confirm by clicking on the link below to complete the process on the system. ");
	...
	public ServerResponse reSendUserPassword(ResendUserActivationCodeDto email) {
		...
		try {
			...
			model.put("salutation", "Dear " + User.getFirstName());
			model.put("message",
					"We received a request to resend your password <br>Use the verification link below to set up a new password for your account. If you did not request to reset your password, ingnore this email");
